...
<html lang="en">
    ...
    (function(d, m){
      var kommunicateSettings = {"appId":"3ad9d0d5d7afaa883f29cd1ea90fddd75","conversationTitle":"Anupam Seal"};
  ...
  <button id="forgetsubmit" name="submit">Send</button>
   ...
   <p><a href="#" id="loginnew">Login Here</a></p>
       ...
       <iframe class="iframe" height="1450px" width="100%" src="Signin/signin.php" style="border:none;float:inherit"></iframe>-->
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="header-search">
								<form id="autosearch" action="" method="post">
                                    <div id="inputwithimg">
